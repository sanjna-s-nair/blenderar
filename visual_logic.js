...
setHTMLElemAttribute('href', 'https://www.behance.net/sanjnasnair', 'info_button', false);
...
operateAnimation('PLAY', 'sanjna_armature', 0, 672, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('sanjna_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'sanjna_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'sanjna_armature', 673, 900, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'sanjna_group'], false);
      ...
      changeVis(['GROUP', 'sanjna_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('sanjna_mesh', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('sanjna_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('sanjna_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'sanjna.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'sanjna_group'], true);
  changeVis(['GROUP', 'indicator_group'], false);
  setObjTransform('sanjna_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('sanjna_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('sanjna_armature', 'XY', 'WORLD', '(lSD#(g#lz7}f{#2kiuu', 'pkYaAIgm1fvc?QSl~Q;/');
}, function() {}, 'pkYaAIgm1fvc?QSl~Q;/');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('sanjna_armature', 'Z', 'WORLD', '@(B!^gJUx*Zw]+$r8Ao[', 'g-NW`]A)v;npxNl0{v2C');
}, function() {}, 'g-NW`]A)v;npxNl0{v2C');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('sanjna_armature', 'Z', '@9?=QjDv4UNQQ}qXOr6w', '$Dn8;M|1m`(-#GEc.^Xs');
  dragScale('sanjna_armature', 'X', 'ZNRm*)B9JL.D^J+rl?_1', '$Dn8;M|1m`(-#GEc.^Xs');
  dragScale('sanjna_armature', 'Y', 'HedLv}wo^C=pYk%CbDo!', '$Dn8;M|1m`(-#GEc.^Xs');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('sanjna_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, '$Dn8;M|1m`(-#GEc.^Xs');
